...
class WiredEdit extends React.Component {
	...
	render () {
		...
		return (
			<div>
				<ConnectionStatus mode="wired" status={this.state.status} data-component-id="connectionStatus" />
				<CheckboxItem
...
export default connect(mapStateToProps, mapDispatchToProps)(WiredEdit);
